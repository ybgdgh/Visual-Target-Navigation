...
# -----------------------------------------------------------------------------
_C.RL.SEDDPPO = CN()
_C.RL.SEDDPPO.pretrained_visual = "data/ddppo-models/resnet50-19c8e357.pth"
# -----------------------------------------------------------------------------
# SLAM-DDPPO
# -----------------------------------------------------------------------------
_C.RL.SLAMDDPPO = CN()
_C.RL.SLAMDDPPO.map_resolution = 5
_C.RL.SLAMDDPPO.map_size_cm = 2400
_C.RL.SLAMDDPPO.obstacle_boundary = 5
_C.RL.SLAMDDPPO.collision_threshold = 0.20
_C.RL.SLAMDDPPO.agent_min_z = 25
_C.RL.SLAMDDPPO.agent_max_z = 150
_C.RL.SLAMDDPPO.agent_view_angle = 0
_C.RL.SLAMDDPPO.du_scale = 2
_C.RL.SLAMDDPPO.vision_range = 64
_C.RL.SLAMDDPPO.visualize = 1
