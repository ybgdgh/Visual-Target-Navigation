...
class ResNetEncoder(nn.Module):
    ...
    def forward(self, observations):
        ...
        # print("*********** cnn_input 0:", cnn_input[0].shape) # torch.Size([4, 3, 256, 256])
        # print("*********** cnn_input 1:", cnn_input[1].shape) # torch.Size([4, 1, 256, 256])
        ...
        # print("**********x:", x.shape) #4 4 128 128

        x = self.backbone(x)
        # print("**********x:", x.shape) #4 1024 4 4
        x = self.compression(x)
        # print("**********x:", x.shape) #4 128 4 4
        return x
...
class PointNavResNetNet(Net):
    ...
    def __init__(
        ...
        # print("resnet: {}".format(np.prod(self.visual_encoder.output_shape))) #2048
        ...
        # print("rnn_input_size: ", rnn_input_size + self._hidden_size) #640 = 512 + 32 * 4
    ...
    def forward(self, observations, rnn_hidden_states, prev_actions, masks):
        ...
        if not self.is_blind:
            ...
            # print("*****************visual_feats :", visual_feats.shape) # 4 128 4 4
            visual_feats = self.visual_fc(visual_feats)
            # print("*****************visual_fc :", visual_feats.shape) # 4 512
