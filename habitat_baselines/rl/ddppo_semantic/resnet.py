...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.layer3(x)
        x = self.layer4(x)
        # print(x.shape) # 4 2048 4 4
        
        x = self.avgpool(x)
        # print(x.shape) # 4 2048 1 1

        x = x.contiguous().view(x.size(0), -1)
        # x = self.fc(x)
        return x

# model_urls = { 'resnet50': 'data/ddppo-models/resnet50-19c8e357.pth',}

def resnet50(pretrain_path, pretrained=False, **kwargs):
